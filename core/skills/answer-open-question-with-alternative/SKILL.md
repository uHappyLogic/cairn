...
`{{PLUGIN_ROOT}}/shared/answer-procedure.md` and follow it unchanged **yourself, in this
...
`{{PLUGIN_ROOT}}/shared/commit-procedure.md`, carrying out its steps yourself. Supply it these inputs, using the
