...
```
python3 {{PLUGIN_ROOT}}/tools/open_questions.py list --unannotated <MILESTONE_DIR>
```
...
```
python3 {{PLUGIN_ROOT}}/tools/open_questions.py locate <MILESTONE_DIR> "<id 1>" "<id 2>" …
```
...
```
python3 {{PLUGIN_ROOT}}/tools/open_questions.py embed <MILESTONE_DIR> "<Short Title>" <<'EOF'
...
the shared commit procedure at `{{PLUGIN_ROOT}}/shared/commit-procedure.md`, carrying out its
...
at `{{PLUGIN_ROOT}}/shared/commit-procedure.md`, carrying out its steps yourself. Supply it
