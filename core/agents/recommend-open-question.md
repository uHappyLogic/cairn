...
`python3 {{PLUGIN_ROOT}}/tools/open_questions.py <subcommand> <MILESTONE_DIR> …`, never a search
of your own over the file.

### 2. Produce the alternatives and the single recommendation

Follow the shared procedure at `{{PLUGIN_ROOT}}/shared/recommend-procedure.md` exactly
